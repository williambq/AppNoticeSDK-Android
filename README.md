...
##Prerequisites
*	A valid App Notice Token and the set of Tracker ID's from Ghostery. (Contact your Ghostery Customer Success Manager to create or manage your App Notice configuration and to get these IDs.)
...
2. Integrate the App Notice SDK into your code:
